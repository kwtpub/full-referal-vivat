...
- **[DEPLOYMENT.md](./DEPLOYMENT.md)** - Детальная инструкция по настройке .env
- **[QUICK_START.md](./QUICK_START.md)** - Быстрый старт для новичков
- **[VPS_REQUIREMENTS.md](./VPS_REQUIREMENTS.md)** - Технические требования для VPS
- **[ADMIN_SETUP.md](./ADMIN_SETUP.md)** - Как назначить пользователя администратором
- **[SUMMARY.md](./SUMMARY.md)** - Резюме всех изменений
